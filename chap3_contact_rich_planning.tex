...
\subfloat[\code{PlanarPushing}.]{
	\includegraphics[width=0.3\linewidth]{figures/03_contact_rich_planning/trajopt_results/planar_pushing.pdf}
}
\subfloat[\code{PlanarHand} Re-orientation.]{
	\includegraphics[width=0.3\linewidth]{figures/03_contact_rich_planning/trajopt_results/planar_hand.pdf}
}
\subfloat[\code{AllegroHand} Rotation.]{
	\includegraphics[width=0.3\linewidth]{figures/03_contact_rich_planning/trajopt_results/allegro_hand.pdf}
}
